insert into customer(id, name) values (1000, 'AAA');
insert into customer(id, name) values (1001, 'BBB');
insert into customer(id, name) values (1002, 'CCC');

insert into my_transaction(id, description, total, save_date, customer_id) values (1001, 'Purchase 1', 100, '2019-11-17 10:20:10', 1000);
